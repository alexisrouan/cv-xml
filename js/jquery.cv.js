                ...
                default:
                  ...
                  $(this).children().each(function() {
                    ...
                    if ($(this).children().length) {
                      ...
                      $(this).text() ? $("section:last-child ul:last-child").append("<li><span class='label " + $(this).get(0).nodeName + "'>" + $(this).getLabel() + "&nbsp;:&nbsp;</span><span class='" + $(this).get(0).nodeName + "-txt'>" + $(this).text() + "</span></li>") : '';
                    }
